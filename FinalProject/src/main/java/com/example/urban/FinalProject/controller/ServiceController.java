...
public class ServiceController {
	...
	return subservice.Subscribe(pur.getReferenceNumber(),pur.getUserId(),pur.getSubserviceId());
	...
	public List<FinalResponse> getSubService(@PathVariable String service)
	{
